...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: `> **TL;DR** — 이 글은 대학생 개발자 여준수(Yeojunsu)의 공식 사이트 yeojoonsoo02.com 런칭 인사글입니다. 프로필·기술 스택·진행 중인 프로젝트·연락처를 간단히 정리합니다. 연락은 yeojoonsoo02@gmail.com.

안녕하세요, 대학생 개발자 **여준수(Yeojunsu)** 입니다.
