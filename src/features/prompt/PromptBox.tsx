          ...
          >
            {messages.map((m, i) => (
              <div key={i} className="space-y-1">
                <div
                  className={`text-sm leading-relaxed break-words whitespace-pre-wrap overflow-wrap-anywhere max-w-[75%] px-3 py-2 rounded-md ${
                    m.role === 'user'
            ...
            {loading && (
              <div className="text-sm leading-relaxed break-words whitespace-pre-wrap overflow-wrap-anywhere max-w-[75%] mr-auto bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 rounded-md">
                {t('typing')}
                {'.'.repeat(dots)}
              </div>
            )}
