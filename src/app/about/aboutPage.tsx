...
const ABOUT_META: Record<Lang, AboutMeta> = {
  ...
  en: {
    ...
    description: "About Junsu Yeo, a student developer. Tech stack, certifications, values and contact.",
  ...
  es: {
    ...
    description: "Sobre Junsu Yeo, estudiante desarrollador. Stack tecnológico, certificaciones y contacto.",
  ...
  pt: {
    ...
    description: "Sobre Junsu Yeo, estudante desenvolvedor. Stack de tecnologia, certificações e contato.",
