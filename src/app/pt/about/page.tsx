...
export default function AboutPagePt(): JSX.Element {
  return (
    <>
      ...
      />
      <AboutContent lang={LANG} heading={"Sou o Junsu Yeo"} intro={"Estudante desenvolvedor. Minha trajetória e projetos estão aqui; o resto, pergunte à IA."} />
    </>
  );
}
