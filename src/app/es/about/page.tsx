...
export default function AboutPageEs(): JSX.Element {
  return (
    <>
      ...
      />
      <AboutContent lang={LANG} heading={"Soy Junsu Yeo"} intro={"Estudiante desarrollador. Aquí está mi trayectoria y mis proyectos; lo demás puedes preguntárselo a la IA."} />
    </>
  );
}
